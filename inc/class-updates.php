	...
	public function gitHubUpdater() {
		...
		if ( $updater === null ) {
			$updater = \Puc_v4_Factory::buildUpdateChecker(
				'https://github.com/pressbooks/pressbooks-cas-sso/',
				\Pressbooks\Utility\absolute_path( __DIR__ . '/../pressbooks-cas-sso.php' ), // Fully qualified path to the main plugin file
				'pressbooks-cas-sso',
				24
			);
